<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="330">
        <template v-if="scope.row.isEnabled === 1" slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="handlePwd(scope.row.id)">密码修改</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 编辑组件 -->
    <edit :title="edit.title" :form-data="edit.formData" :visible="edit.visible" :remote-close="remoteClose" />
